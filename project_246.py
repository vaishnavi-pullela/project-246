...
def ethereum_block():
    ...
    gas_price_in_dollar = gas_price_in_ether * 3689.68
    gas_price_in_ruprees = gas_price_in_ether * 307800.17
    gas_price_in_pounds = gas_price_in_ether * 2995.401547
    ...
    value_in_rupees["text"] = "Value of gas in ruprees: ₹" + str(gas_price_in_ruprees)
